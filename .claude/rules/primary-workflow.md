...
- **Open Source Reference Mode (`/plan:ref`)**: Search for and analyze similar open source projects in the domain:
  - Use `researcher` agent to find best-in-class open source solutions
  - Clone/pull top repositories to `./reference/` for detailed analysis
  - Document key patterns, architecture decisions, and code structures to learn from
  - Apply insights to the implementation plan
